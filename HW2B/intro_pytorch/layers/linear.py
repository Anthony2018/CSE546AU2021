...
class LinearLayer(nn.Module):
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.weight = nn.Parameter(torch.randn((dim_in, dim_out), dtype=torch.float32, generator=generator))
        self.bias = nn.Parameter(torch.randn((1, dim_out), dtype=torch.float32, generator=generator))
